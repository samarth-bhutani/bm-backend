...
class DiningHallScraper:
    ...
    '''
    def scrape_menus(self, dining_halls, menu_urls, dining_hall_names):
    ...
    def scrape(self):
        ...
        self.scrape_details(dining_halls_information, dining_hall_names)
        self.scrape_menus(dining_halls_information, menu_urls, dining_hall_names)
