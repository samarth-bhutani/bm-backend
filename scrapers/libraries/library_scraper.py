...
class LibraryScraper():
    ...
    def remove_library_ids(self, libraries, library_names):
        '''
    ...
    def get_library_url(self, library_id):
        '''
    ...
    def scrape_library_hours(self, libraries, library_names):
        '''
        ...
        for library_name in library_names:
            ...
            url = self.get_library_url(library_id)
            try:
                ...
                for days in hours_dict:
                    ...
                    day_hours = self.parse_hours(days["day"])
    ...
    def scrape(self):
        ...
        library_names = ["Anthropology Library", "Art History/Classics Library", "BAMPFA Film Library & Study Center",
                         ...
                         "Environmental Design Library", "Ethnic Studies Library", "Graduate Theological Union Library",
        ...
        self.initialize_libraries_dict(libraries, library_names)
        self.set_library_ids(libraries)
        self.scrape_library_hours(libraries, library_names)
